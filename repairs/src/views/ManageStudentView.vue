...
export default {
  ...
  data() {
    return {
      searchKey: "",
      studentList: [
        { id: 1, account: "2023123456", password: "123456" },
        { id: 2, account: "2023123457", password: "123456" },
        { id: 3, account: "2023123458", password: "123456" },
        { id: 4, account: "2023123459", password: "123456" }
      ],
  ...
  methods: {
    ...
    const target = this.studentList.find(
        item => item.id === this.editForm.id
    );

    if (target) {
        target.password = this.editForm.password;
    }
